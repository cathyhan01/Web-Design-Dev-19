...
function yellowButtonClicked() {
  document.getElementById("q1-container").style.backgroundColor = "#FFD166";
}
...
function greenButtonClicked() {
  document.getElementById("q1-container").style.backgroundColor = "#06D6A0";
}
...
function lightBlueButtonClicked() {
  document.getElementById("q1-container").style.backgroundColor = "#118AB2";
}
...
function blueButtonClicked() {
  document.getElementById("q1-container").style.backgroundColor = "#073B4C";
}
